package com.asantos.dslearn.dto;
...
public class NotificationDTO implements Serializable {
	...
	public NotificationDTO(Notification notificationEntity) {
		id = notificationEntity.getId();
		text = notificationEntity.getText();
		moment = notificationEntity.getMoment();
		read = notificationEntity.isRead();
		route = notificationEntity.getRoute();
